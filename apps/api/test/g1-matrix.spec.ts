...
const ENDPOINTS: Array<{
  ...
  { id: 'POST /boards/attachments/complete', method: 'post', path: '/api/v1/boards/attachments/complete', body: { uploadId: '00000000-0000-0000-0000-000000000000', checksum: 'c', name: 'x.png' } },
